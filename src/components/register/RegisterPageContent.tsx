      ...
      >
        <div className="w-full max-w-[520px] rounded-3xl border border-border/70 bg-background px-6 py-7 shadow-[0_22px_60px_-42px_var(--navy)] sm:px-10 sm:py-9">
          ...
          <div className="mt-8 text-right">
            <h1 className="text-3xl font-black text-navy sm:text-4xl">ابدأ الآن مجانًا!</h1>
            <p className="mt-2 text-base leading-7 text-muted-foreground sm:text-lg">
              أدخل بريدك الإلكتروني وانطلق نحو تحقيق الأرباح
            </p>
          </div>

          <form className="mt-7" noValidate onSubmit={handleSubmit}>
            <label htmlFor="register-email" className="mb-2 block text-sm font-bold text-navy">
              البريد الإلكتروني
            </label>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            عندك حساب؟{" "}
            <Link to="/login" className="font-bold text-register-primary hover:underline">
              سجل دخولك
            </Link>
          </p>
          ...
          <p className="mt-8 text-center text-xs leading-6 text-muted-foreground">
            ...
            <a href="#" onClick={(event) => event.preventDefault()} className="font-medium text-navy underline underline-offset-2">
              الشروط
            </a>{" "}
            و{" "}
            <a href="#" onClick={(event) => event.preventDefault()} className="font-medium text-navy underline underline-offset-2">
