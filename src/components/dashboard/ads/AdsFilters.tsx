...
export function AdsFilters({
  ...
  return (
    <div className="grid gap-3 rounded-2xl border border-border bg-card p-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-[1.45fr_1fr_1fr_1fr_1fr_1fr_auto] xl:items-center">
      ...
      <div className="min-w-0 xl:order-6">
        <SelectBox
          icon={ArrowUpDown}
          label="الترتيب"
          value={value.sort}
      ...
      <div className="flex xl:order-7">
        <button
          type="button"
          onClick={onClear}
          disabled={!hasActiveFilters}
          className={`inline-flex h-12 items-center justify-center gap-2 rounded-2xl px-4 text-[13px] font-black transition-colors ${
            hasActiveFilters
